...
@section('content3')
        ...
        <div id="page-wrapper" style="min-height: 586px;">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Ingresar Curso</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
...
<div style="float: right;width: 450px;">
  ...
  <div class="highlight" data-example-id="condensed-table" style="  width: 500px;background-color: rgb(225, 232, 236);">
                  ...
                  {!! Form::open(['route' => 'Encargado.subirCursos.index',
     ...
     <div class="form-group">
           ...
           <div class="highlight" data-example-id="condensed-table" style="width:650px">
                 ...
                 {!! Form::open(['route' => 'Encargado.cursos.store', 'method' => 'POST']) !!}
                    <form role="form">
                        ...
                        <div class="form-group" style="width:900px">
                         ...
                         <button type="submit" class="btn btn-primary">Crear</button>
                          <a class="btn btn-default" href="{{url('Encargado/cursos')}}" role="button">Cancelar</a>
