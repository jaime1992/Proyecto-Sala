...
@section('content3')
        ...
        <div id="page-wrapper" style="min-height: 586px;">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Ingresar Estudiante</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
     ...
     <div class="highlight" data-example-id="condensed-table" style="  width: 500px;background-color: rgb(225, 232, 236);">
                  {!! Form::open(['route' => 'Encargado.subirEstudiantes.index',
     ...
     <div class="form-group">
          ...
          <div class="highlight" data-example-id="condensed-table" style="width:650px">
                 ...
                 {!! Form::open(['route' => 'Encargado.estudiantes.store', 'method' => 'POST']) !!}
                    <form role="form" >
                      ...
                      <div class="form-group" style="width:900px">
                       ...
                       <div class="form-group" style="width:900px">
                         ...
                         <button type="submit" class="btn btn-primary">Crear</button>
                          <a class="btn btn-default" href="{{url('Encargado/asignaturas')}}" role="button">Cancelar</a>
