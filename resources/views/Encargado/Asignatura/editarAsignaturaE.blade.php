        ...
        <div id="page-wrapper" style="min-height: 586px;">
            <div class="container-fluid">
                <div class="row">
                   ...
                   {!! Form::model($asignaturas, ['route' => ['Encargado.asignaturas.update', $asignaturas],
                  'method' => 'PUT']) !!}
                      ...
                      <div class="form-group" style="width:900px">
                        ...
                        <div class="form-group" style="width:900px">
                         ...
                         <button type="submit" class="btn btn-info">Editar </button>
                          <a class="btn btn-primary" href="{{url('Encargado/asignaturas')}}" role="button">Cancelar</a>
                  ...
                  {!! Form::open(['route' => ['Encargado.asignaturas.destroy', $asignaturas], 'method' => 'DELETE']) !!}
