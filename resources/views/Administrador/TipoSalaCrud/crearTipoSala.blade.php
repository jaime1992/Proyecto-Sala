...
@section('content')
        ...
        <div id="page-wrapper" style="min-height: 586px;">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Crear Tipo de Salas</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
...
<div style="float: right;width: 450px;">
 ...
 {!! Form::open(['route' => 'Administrador.subirTipoSala.index','method' =>'POST','enctype' =>'multipart/form-data']) !!}
<div class="form-group">
          ...
          <div class="highlight" data-example-id="condensed-table" style="width:650px">
                 ...
                 {!! Form::open(['route' => 'Administrador.tiposSalas.store', 'method' => 'POST']) !!}
                    <form role="form">
                        ...
                        <div class="form-group" style="width:900px">
                         ...
                         <button type="submit" class="btn btn-warning">Crear</button>
                          <a class="btn btn-danger" href="{{url('Administrador/tiposSalas')}}" role="button">Cancelar</a>
