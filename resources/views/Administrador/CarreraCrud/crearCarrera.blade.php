...
@section('content')
        ...
        <div id="page-wrapper" style="min-height: 586px;">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Crear Carrera</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
      ...
      @endif
         ...
         {!! Form::open(['route' => 'Administrador.subirCarreras.index',
...
<div class="highlight" data-example-id="condensed-table" style="width:650px">
                 ...
                 {!! Form::open(['route' => 'Administrador.carreras.store', 'method' => 'POST']) !!}
                    <form role="form">
                      ...
                      <div class="form-group" style="width:900px">
                         ...
                         <a class="btn btn-danger" href="{{url('Administrador/carreras')}}" role="button">Cancelar</a>
