...
@section('content')
        ...
        <div id="page-wrapper" style="min-height: 586px;">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Crear Funcionario</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
...
<div style="float: right;width: 450px;">
     <div class="highlight" data-example-id="condensed-table" style="  width: 500px;background-color: rgb(225, 232, 236);">
                  {!! Form::open(['route' => 'Administrador.subirFuncionarios.index',
    ...
    <div class="form-group">
            ...
            <div class="highlight" data-example-id="condensed-table" style="width:650px">
                 ...
                 {!! Form::open(['route' => 'Administrador.funcionarios.store', 'method' => 'POST']) !!}
                    <form role="form">

                         <div class="form-group" style="width:900px">
                         {!! Form::label('rut', 'Rut') !!}
                            {!! Form::text('rut', '',['class' => 'form-control',
                             'placeholder' => 'Ej: 18116826 (Sin digito verificador)']) !!}
                        </div>
                        ...
                        <div class="form-group" style="width:900px">
                         ...
                         <a class="btn btn-danger" href="{{url('Administrador/funcionarios')}}" role="button">Cancelar</a>
