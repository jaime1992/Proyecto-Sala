            ...
            <div class="container-fluid">
                <div class="row">
                 ...
                 @if ($errors->any())
                  ...
                  {!! Form::open(['route' => 'Administrador.subirHorarios.index',
     'method' =>'POST','enctype' =>'multipart/form-data']) !!}
         <div class="form-group">
          ...
          <div class="highlight" data-example-id="condensed-table" style="width:650px">
                 ...
                 {!! Form::open(['route' => 'Administrador.horarios.store', 'method' => 'POST']) !!}
                    <form role="form">
                         ...
                         {!! Form::label('nombre', 'Pertenece a Sala: ') !!}
                         {!! Form::select('sala_id', $salas) !!}
                        
                        </div>
                         <div class="form-group" style="width:900px">

                         {!! Form::label('bloque', 'Pertenece a Bloque: ') !!}
                        ...
                        {!! Form::label('seccion', 'Pertenece a curso: ') !!}
                         ...
                         <a class="btn btn-danger" href="{{url('Administrador/horarios')}}" role="button">Cancelar</a>
