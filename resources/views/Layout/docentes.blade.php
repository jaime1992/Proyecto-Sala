            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="{{url('Docente/bienvenido')}}"><i class="fa fa-dashboard fa-fw"></i> Inicio</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-paint-brush fa-fw"></i> Consultas<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse">
                                
                               
                                 <li>
                                    <a href="{{url('Docente/consultas')}}">Consultas Específicas</a>
                                </li> 
                            </ul>                      
                        </li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-arrows-alt fa-fw"></i> Accesos Directos<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse">
                                 <li>
